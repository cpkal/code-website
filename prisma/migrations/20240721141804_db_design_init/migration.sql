...
-- AddForeignKey
ALTER TABLE "Progress" ADD CONSTRAINT "Progress_courseDetailsId_fkey" FOREIGN KEY ("courseDetailsId") REFERENCES "CourseDetails"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
